...
export default function Home() {
  ...
  const clear = () => { setBuilders([]); setPromoters([]); setTalukas([]); setTypes([]); setCompletionStart(""); setCompletionEnd(""); setApprovalStart(""); setApprovalEnd(""); setMinimumUnits(""); setMaximumUnits(""); setHasUpdate(true); };
