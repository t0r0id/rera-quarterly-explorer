...
export default function Home() {
  ...
  return <main>
    ...
    <p className="metric-note">Inventory includes all filtered projects, using project-details units when report data is missing. Inventory with sales published and Booked % include only reporting projects. Mar 2026 falls back to Dec 2025 when March is missing. Unsold sums reported available units only. Headline figures use the latest available report.</p>
