...
export default function Home() {
  ...
  const [completionStart, setCompletionStart] = useState(""), [completionEnd, setCompletionEnd] = useState(""), [approvalStart, setApprovalStart] = useState(""), [approvalEnd, setApprovalEnd] = useState(""), [hasUpdate, setHasUpdate] = useState(true), [sort, setSort] = useState<Sort>({ key: "Approved On", direction: "desc" });
